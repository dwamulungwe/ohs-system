...
const toneMap = {
  ...
  under_investigation: 'bg-yellow-100 text-yellow-800 ring-yellow-200',
  actions_open: 'bg-amber-100 text-amber-800 ring-amber-200',
  pending_closure: 'bg-violet-100 text-violet-800 ring-violet-200',
  reported: 'bg-sky-100 text-sky-800 ring-sky-200',
  triaged: 'bg-violet-100 text-violet-800 ring-violet-200',
  pending_review: 'bg-violet-100 text-violet-800 ring-violet-200',
  ...
  locked: 'bg-violet-100 text-violet-800 ring-violet-200',
  reopened: 'bg-orange-100 text-orange-800 ring-orange-200',
  good: 'bg-emerald-100 text-emerald-800 ring-emerald-200',
  informational: 'bg-sky-100 text-sky-800 ring-sky-200',
  insufficient_data: 'bg-stone-200 text-stone-700 ring-stone-300',
