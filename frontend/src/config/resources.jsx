...
export const resources = [
  ...
  },
  {
    ...
    filters: [
      ...
      { name: 'status', label: 'Status', type: 'select', options: ['unassigned', 'assigned_to_responsible_person', 'assigned_to_action_tracker', 'complete', 'no_action_required', 'open'] },
    ...
    columns: [
      { key: 'external_reference_id', label: 'Reference' },
