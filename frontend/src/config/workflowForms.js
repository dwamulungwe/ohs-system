...
export const workflowFormConfigs = {
  ...
  sios: {
    ...
    fields: [
      ...
      baseTextField('incident_classification', 'Incident classification'),
      {
        name: 'status',
        label: 'Status',
        type: 'select',
      ...
      },
      {
        ...
        label: 'Observation nature',
        type: 'select',
        required: true,
        options: buildSelectOptions(['positive', 'negative']),
      },
      {
        name: 'urgency',
        label: 'Urgency',
      ...
      baseTextField('responsible_department', 'Responsible department'),
      {
        ...
        label: 'Responsible H&S officer user',
        type: 'select',
        optionsSource: 'users',
