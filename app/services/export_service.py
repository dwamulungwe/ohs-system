...
def export_sios_csv(
    ...
    *,
    ...
    headers = [
        "Reference Number", "External Reference ID", "Source System", "Observation Date",
        "Site", "Site ID",
        "Originating Department", "Originating Department ID", "Responsible Department",
        "Responsible Department ID", "Responsible H&S Officer", "Responsible H&S Officer User ID",
        "Responsible User ID", "Responsible Person", "Source", "Incident Classification",
        "Category", "Nature", "Urgency", "Status", "Property Damage", "Source Created At",
        "Source Created By", "Source Modified By", "Source Path", "Legacy Metadata",
        "Due Date", "Age Days", "Days Overdue",
    ...
    rows = [
        {
            ...
            "Source System": item.source_system or "",
            "Observation Date": _date_value(item.observation_date),
            "Site": item.site.name if item.site else "",
            "Site ID": item.site_id,
            ...
            "Responsible H&S Officer": item.responsible_hs_officer_name or "",
            "Responsible H&S Officer User ID": item.responsible_hs_officer_user_id or "",
            "Responsible User ID": item.responsible_user_id or "",
            "Responsible Person": item.responsible_person_name or "",
            "Source": item.source_type,
            "Incident Classification": item.incident_classification or "",
            "Category": item.category or "",
            "Nature": _enum_value(item.observation_nature),
            "Urgency": _enum_value(item.urgency) if item.urgency else "",
            "Status": _enum_value(item.status),
            "Property Damage": item.property_damage or "",
            "Source Created At": _date_value(item.source_created_at),
            "Source Created By": item.source_created_by or "",
            "Source Modified By": item.source_modified_by or "",
            "Source Path": item.source_path or "",
            "Legacy Metadata": _json_value(item.legacy_metadata),
